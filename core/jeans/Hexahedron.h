...
public:
    ...
    virtual double getElementJEANS(vector<Point3D> &points);
...
protected:
    ...
    virtual double getDet(vector<Point3D> &points,  const Point3D &p);
    
};
//memorist
inline unsigned int Hexahedron::numberOfFaces() {
    return 6;
}
//--
